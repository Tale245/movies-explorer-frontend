        ...
        <div className="aboutMe__container_info">
          <div className="aboutMe__container_description">
            ...
            <p className="aboutMe__description">
              Я родился в Кирове, живу в Москве. Я люблю слушать музыку, а ещё увлекаюсь
              видеомонтажом. Недавно начал кодить. После того, как прошёл курс по веб-разработке, начал
              заниматься фриланс-заказами и ушёл с постоянной работы.
            </p>
            <a className="aboutMe__link" href="https://github.com/Tale245">GitHub</a>
          </div>
